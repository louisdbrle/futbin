...
std::vector<Player*> draw_player_card(std::vector<Player>* db_players, uint8_t nb_card) {
...
std::vector<Coach*> draw_coach_card(std::vector<Coach>* db_coachs, uint8_t nb_card) {
